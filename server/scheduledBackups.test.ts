...
describe("callback planifié de sauvegarde", () => {
  ...
  it("exécute une sauvegarde pour la tâche planifiée active", async () => {
    ...
    const settings = { scheduleCronTaskUid: "task-1", automaticEnabled: true, updatedByUserId: 7, retentionCount: 14 };
    ...
    await runScheduledBackup({} as any, res as any);
    expect(mocks.runBackup).toHaveBeenCalledWith(7, "scheduled", 14);
