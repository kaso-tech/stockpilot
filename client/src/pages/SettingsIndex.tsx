...
export const settingsSections: SettingsSection[] = [
  {
    ...
    detail: "Configurez l’organisation du comptoir, les tickets et les autorisations vendeurs.",
    links: [
  ...
  },
  {
    ...
    links: [{ href: "/parametres/identite", icon: Building2, label: "Identité et impression", detail: "Logo, signature et documents A4", keywords: "entreprise société logo signature facture" }],
  },
  {
    id: "appearance",
    label: "Affichage et devise",
    detail: "Les réglages visuels et monétaires qui influencent l’ensemble de l’espace.",
    links: [
  ...
  },
  {
    id: "fiscal",
    label: "Fiscalité",
    detail: "Définissez les règles de taxe appliquées aux nouveaux documents commerciaux.",
  ...
  },
  {
    id: "management",
    label: "Pilotage",
    detail: "Adaptez le cockpit aux indicateurs utiles à votre équipe.",
  ...
  },
  {
    ...
    detail: "Protégez les accès et consultez les changements effectués dans l’espace.",
    links: [
  ...
  },
  {
    ...
    detail: "Préparez vos archives et vos opérations de maintenance.",
