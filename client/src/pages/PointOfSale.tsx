...
export default function PointOfSale() {
  ...
  const lines = cart.map(item => {
    ...
    return { ...item, product, subtotalCents, discountCents, totalCents: subtotalCents - discountCents, remainingAfterSale, isLowStock: lineIsLowStock };
