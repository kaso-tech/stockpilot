...
function HeaderActions({ canRunBackup, compact = false, pending, onBackup, notifications, onNotification }: { canRunBackup: boolean; compact?: boolean; pending: boolean; onBackup: () => void; notifications: Array<{ id: string; title: string; detail: string; tone: "amber" | "violet" | "rose"; path: string }>; onNotification: (path: string) => void }) {
